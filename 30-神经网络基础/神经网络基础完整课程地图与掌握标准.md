...
| 现行教学迁移 | 60 / 64 | NN-01—60 已由[[neural_network_foundations_teaching_contract_audit.py]]复核教学合同与共享算例 |
| 待迁移节点 | 4 / 64 | NN-61—64 保留既有正文、题解与图，但尚未按现行教学合同回归 |
...
| 已通过分卷 | 0 | 尚无真实学习证据 |
| 下一材料施工点 | NN-61—64 | 完成 30.8 的 Label Smoothing、Mixup、导数正则与交互证据地图 |

当前状态是 **60/64 教学迁移完成、4/64 待迁移、材料门 7/8、30.8 前半卷 `in-progress`、个人 `not-attempted`**。
