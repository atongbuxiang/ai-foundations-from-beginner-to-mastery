...
| 现行教学迁移 | 40 / 64 | NN-01—40 已由[[neural_network_foundations_teaching_contract_audit.py]]复核教学合同与共享算例 |
| 待迁移节点 | 24 / 64 | NN-41—64 保留既有正文、题解与图，但尚未按现行教学合同回归 |
| 分卷材料回归 | 5 / 8 | 30.1—30.5 的节点、题解、正式图、来源与共享 fixture 已通过；个人仍为 `not-attempted` |
| 旧章节累计门 | composed | NN-CUM-01 题卷、独立解答与计算复现门已组成；须在节点迁移与分卷门升级后重新审计 |
| 已通过分卷 | 0 | 尚无真实学习证据 |
| 下一材料施工点 | NN-41—44 | 开始 30.6 残差学习、Jacobian、ODE 与深度缩放 |

当前状态是 **40/64 教学迁移完成、24/64 待迁移、材料门 5/8、30.5 已 `regression-passed`、个人 `not-attempted`**。
