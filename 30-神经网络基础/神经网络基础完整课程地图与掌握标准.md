...
| 现行教学迁移 | 52 / 64 | NN-01—52 已由[[neural_network_foundations_teaching_contract_audit.py]]复核教学合同与共享算例 |
| 待迁移节点 | 12 / 64 | NN-53—64 保留既有正文、题解与图，但尚未按现行教学合同回归 |
...
| 已通过分卷 | 0 | 尚无真实学习证据 |
| 下一材料施工点 | NN-53—56 | 完成 30.7 的 Softmax bottleneck、大词表近似、离散边界与压缩接口 |

当前状态是 **52/64 教学迁移完成、12/64 待迁移、材料门 6/8、30.7 前半卷 `in-progress`、个人 `not-attempted`**。
