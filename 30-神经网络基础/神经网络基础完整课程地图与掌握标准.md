...
| 现行教学迁移 | 36 / 64 | NN-01—36 已由[[neural_network_foundations_teaching_contract_audit.py]]复核教学合同与共享算例 |
| 待迁移节点 | 28 / 64 | NN-37—64 保留既有正文、题解与图，但尚未按现行教学合同回归 |
...
| 已通过分卷 | 0 | 尚无真实学习证据 |
| 下一材料施工点 | NN-37—40 | 完成 30.5 的 RMSNorm、归一化族、放置与系统边界 |

当前状态是 **36/64 教学迁移完成、28/64 待迁移、材料门 4/8、30.5 前半卷 `in-progress`、个人 `not-attempted`**。
