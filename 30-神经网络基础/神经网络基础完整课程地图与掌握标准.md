...
| 现行教学迁移 | 44 / 64 | NN-01—44 已由[[neural_network_foundations_teaching_contract_audit.py]]复核教学合同与共享算例 |
| 待迁移节点 | 20 / 64 | NN-45—64 保留既有正文、题解与图，但尚未按现行教学合同回归 |
...
| 已通过分卷 | 0 | 尚无真实学习证据 |
| 下一材料施工点 | NN-45—48 | 完成 30.6 的放置、skip 谱系、超深缩放与证据地图 |

当前状态是 **44/64 教学迁移完成、20/64 待迁移、材料门 5/8、30.6 前半卷 `in-progress`、个人 `not-attempted`**。
