...
| 现行教学迁移 | 24 / 64 | NN-01—24 已由[[neural_network_foundations_teaching_contract_audit.py]]复核教学合同与共享算例 |
| 待迁移节点 | 40 / 64 | NN-25—64 保留既有正文、题解与图，但尚未按现行教学合同回归 |
...
| 已通过分卷 | 0 | 尚无真实学习证据 |
| 下一材料施工点 | NN-25—28 | 开始 30.4 初始化与信号传播前半卷 |

当前状态是 **24/64 教学迁移完成、40/64 待迁移、材料门 3/8、30.3 已 `regression-passed`、个人 `not-attempted`**。
