...
| 现行教学迁移 | 20 / 64 | NN-01—20 已由[[neural_network_foundations_teaching_contract_audit.py]]复核教学合同与共享算例 |
| 待迁移节点 | 44 / 64 | NN-21—64 保留既有正文、题解与图，但尚未按现行教学合同回归 |
...
| 已通过分卷 | 0 | 尚无真实学习证据 |
| 下一材料施工点 | NN-21—24 | 完成 30.3 后半卷 |

当前状态是 **20/64 教学迁移完成、44/64 待迁移、材料门 2/8、30.3 为 4/8 in-progress、个人 `not-attempted`**。
