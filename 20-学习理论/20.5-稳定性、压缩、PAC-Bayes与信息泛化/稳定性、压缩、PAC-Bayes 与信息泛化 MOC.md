...
因此本卷的**验收材料**为 `regression-passed`，但学习者仍为 `not-attempted`，不得把 8/8 材料闭环写成个人通过。全章卷级材料门现为 **5/10**。

前五卷的[[资格考 - 学习理论 I：从风险到算法依赖泛化（20.1—20.5）|LT-QUAL-01]]、独立详解与[[实验 - 学习理论资格考 I 跨卷累计复现门|三轨累计复现门]]现已建立；资格考材料门为 **1/2**，个人资格仍为 **0/2 / `not-attempted`**。下一步进入 20.6。
