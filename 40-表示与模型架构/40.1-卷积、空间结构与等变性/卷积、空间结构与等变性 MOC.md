...
- **状态边界：** 本卷 ARCH-01—08 为 8/8 `regression-passed`；全章现行教学迁移已推进至 ARCH-01—20（20/64），40.1—40.2 材料门占全章 2/8，40.3 为 4/8 迁移中，个人仍为 `not-attempted`。
...
当前本卷为 **8/8 现行教学迁移、全章 2/8 分卷材料门、0/8 个人学习验收**；全章为 **ARCH-01—20（20/64）**。ARCH-01—08 已通过[[architecture_teaching_contract_audit.py]]的结构、题解、链接、独立数值与八图双跑回归；40.1 材料为 `regression-passed`，当前施工点已移至 ARCH-21—24，个人保持 `not-attempted`。
