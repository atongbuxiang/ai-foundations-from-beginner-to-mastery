...
- **状态边界：** ARCH-01—08 的材料迁移为 8/64，40.1 材料门 1/8 `regression-passed`，个人仍为 `not-attempted`。
...
当前为 **8/8 现行教学迁移、1/8 分卷材料门、0/8 个人学习验收**。ARCH-01—08 已通过[[architecture_teaching_contract_audit.py]]的结构、题解、链接、独立数值与八图双跑回归；40.1 材料为 `regression-passed`，下一施工点为 ARCH-09—12，个人保持 `not-attempted`。
