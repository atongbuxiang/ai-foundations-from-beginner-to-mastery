...
> ARCH-01—12 已完成三波教学重写并由[[architecture_teaching_contract_audit.py]]独立复核，迁移范围为 **12/64**；40.1 为 **8/8 `regression-passed`**，40.2 前半卷为 **4/8 `in-progress`**，分卷材料门为 **1/8**。正文 `draft` 与个人 `not-attempted` 不变，旧“静态材料完成”只说明文件、题解和图存在。
...
| 现行教学迁移 | 12 / 64 | ARCH-01—12 已满足当前初学者教学合同 |
| 分卷验收门 | 1 / 8 | 40.1 已回归通过；40.2 前半卷完成，下一施工点为 ARCH-13—16 |
