...
> ARCH-01—16 已完成四波教学重写并由[[architecture_teaching_contract_audit.py]]独立复核，迁移范围为 **16/64**；40.1 与 40.2 均为 **8/8 `regression-passed`**，分卷材料门为 **2/8**。正文 `draft` 与个人 `not-attempted` 不变，旧“静态材料完成”只说明文件、题解和图存在。
...
| 现行教学迁移 | 16 / 64 | ARCH-01—16 已满足当前初学者教学合同 |
| 分卷验收门 | 2 / 8 | 40.1、40.2 已回归通过；下一施工点为 ARCH-17—20 |
