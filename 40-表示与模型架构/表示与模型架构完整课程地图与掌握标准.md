...
> ARCH-01—08 已完成两波教学重写并由[[architecture_teaching_contract_audit.py]]独立复核，迁移范围为 **8/64**；40.1 为 **8/8 `regression-passed`**，分卷材料门为 **1/8**。正文 `draft` 与个人 `not-attempted` 不变，旧“静态材料完成”只说明文件、题解和图存在。
...
| 现行教学迁移 | 8 / 64 | ARCH-01—08 已满足当前初学者教学合同 |
| 分卷验收门 | 1 / 8 | 40.1 已回归通过；下一施工点为 40.2 |
