...
> [!info] 当前教学迁移快照
> ARCH-01—16 已按当前“课程位置—两遍路线—问题链—对象账本—贯穿算例—公式七问”标准完成四波迁移，现行范围为 **16/64**；40.1 与 40.2 均为 **8/8 `regression-passed`**，分卷材料门为 **2/8**。节点正文继续保留 `draft`，个人学习严格保持 `not-attempted`。
...
- 当前教学标准迁移：ARCH-01—16 为 16/64，ARCH-17—64 尚待按初学者问题链重审；
- 40.1 与 40.2 当前均为 8/8 `regression-passed`，分卷材料门为 2/8；40.3—40.8 的旧静态材料不等于现行教学迁移完成；
