...
- 当前语义：现行迁移 **52/64**，材料门 **6/8**，30.7 前半卷 `in-progress`，NN-53—64 **12/64 pending**，个人 `not-attempted`；
- 旧[[实验 - 神经网络基础累计复现门]]和 `NN-CUM-01` 保留为 `composed` 历史材料，待 64 节迁移与分卷证据门建成后重新升级；
- 下一施工点：NN-53—56，完成 30.7 的 Softmax bottleneck、大词表近似、padding/mask 事务与 embedding 压缩。
