...
def audit_prerequisite_and_state() -> None:
    ...
    for path in STATE_SURFACES:
        ...
        require("10/10" in content or "10 / 10" in content or path == MOC, f"state surface misses 10/10 material count: {path.relative_to(ROOT)}")
    ...
    print("PASS state surfaces: REPR-CUM-01 current material=10/10, learner=0/10/not-attempted")
