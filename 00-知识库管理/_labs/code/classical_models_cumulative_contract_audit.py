...
def audit_prerequisite_and_state() -> None:
    ...
    for path in STATE_SURFACES:
        ...
        require(re.search(r"9\s*/\s*10", content) is not None or path == MOC,
    ...
    print("PASS state surfaces: MODEL-CUM-01 retained as prerequisite, current material=9/10, learner=0/10/not-attempted")
