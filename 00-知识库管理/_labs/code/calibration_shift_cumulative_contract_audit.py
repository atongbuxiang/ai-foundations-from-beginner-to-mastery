...
def audit_prerequisite_and_state() -> None:
    ...
    for path in STATE_SURFACES:
        ...
        require("8/10" in content or "8 / 10" in content, f"state surface misses 8/10: {path.relative_to(ROOT)}")
    ...
    print("PASS state surfaces: REL-CUM-01 material=8/10, learner=0/10/not-attempted")
