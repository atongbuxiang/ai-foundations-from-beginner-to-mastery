...
每套均包含 A–E 分层训练与独立解答。神经网络基础已有 64 组 960 题；[[neural_network_foundations_teaching_contract_audit.py]]确认 NN-01—24 现行迁移 **24/64**，30.1—30.3 材料门 **3/8 `regression-passed`**，NN-25—64 尚有 **40/64** 待迁移。旧 NN-CUM-01 仍为 `composed`，个人保持 `not-attempted`。
...
| NN-CUM-01 | NN-01—64：神经网络基础第三章累计验收 | legacy composed：现行迁移 24/64、待迁移 40/64，材料门 3/8，30.3 `regression-passed`，个人 not-attempted |
