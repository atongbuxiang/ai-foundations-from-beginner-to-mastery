...
| ARCH-CAP-01 | ARCH-01—64：表示与模型架构第四章跨卷累计验收 | composed：ARCH-01—24 已完成 24/64 现行教学迁移，40.1—40.3 材料门 3/8 `regression-passed`，并由[[architecture_teaching_contract_audit.py]]复核；全章累计门尚未升级，个人 `not-attempted` |
