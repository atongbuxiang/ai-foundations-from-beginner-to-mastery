...
每套均包含 A–E 分层训练与独立解答。神经网络基础已有 64 组 960 题；[[neural_network_foundations_teaching_contract_audit.py]]确认 NN-01—64 现行迁移 **64/64**，待迁移 **0/64**，30.1—30.8 材料门 **8/8 `regression-passed`**。旧 NN-CUM-01 仍为 `composed` 并等待现行合同重审，个人保持 `not-attempted`。
...
| NN-CUM-01 | NN-01—64：神经网络基础第三章累计验收 | legacy composed：现行迁移 64/64、待迁移 0/64，材料门 8/8 regression-passed；累计门本身仍待现行合同重审，个人 not-attempted；由[[neural_network_foundations_teaching_contract_audit.py]]复核节点与分卷材料 |
