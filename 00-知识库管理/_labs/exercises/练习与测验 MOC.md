...
每套均包含 A–E 分层训练与独立解答。神经网络基础已有 64 组 960 题；[[neural_network_foundations_teaching_contract_audit.py]]确认 NN-01—52 现行迁移 **52/64**，30.1—30.6 材料门 **6/8 `regression-passed`**，30.7 前半卷 `in-progress`，NN-53—64 尚有 **12/64** 待迁移。旧 NN-CUM-01 仍为 `composed`，个人保持 `not-attempted`。
...
| NN-CUM-01 | NN-01—64：神经网络基础第三章累计验收 | legacy composed：现行迁移 52/64、待迁移 12/64，材料门 6/8，30.7 前半卷 in-progress，个人 not-attempted；由[[neural_network_foundations_teaching_contract_audit.py]]复核 |
